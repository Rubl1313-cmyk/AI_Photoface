...
✅ user_data: dict = {} ← ПРАВИЛЬНЫЙ СИНТАКСИС (НАКОНЕЦ-ТО!)
"""
...
# ============================================================================
# ✅ ГЛОБАЛЬНЫЕ — ПРАВИЛЬНЫЙ СИНТАКСИС НАКОНЕЦ-ТО!
# ============================================================================

bot = Bot(token=TG_BOT_TOKEN)
dp = Dispatcher()
face_swapper = None
user_data: dict = {}  # ✅ ПРАВИЛЬНО: user_data: dict = {}
...
async def got_photo(m: types.Message, state: FSMContext):
    ...
    try:
        ...
        await m.answer("📝 Описание:", reply_markup=ReplyKeyboardRemove(), parse_mode="Markdown")
